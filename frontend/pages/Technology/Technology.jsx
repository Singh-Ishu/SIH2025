            ...
            <div className={styles.technologyContent}>
                    ...
                    <div className={styles.rustBenefits}>
                        <div className={styles.benefitCard}>
                            ...
                            <p className={styles.benefitText}>
                                ...
                                guarantees, crucial for low-level hardware
                                operations and data wiping algorithms.
                            </p>
                        </div>
                        <div className={styles.benefitCard}>
                            <div className={styles.benefitIcon}></div>
                            ...
                            <p className={styles.benefitText}>
                                ...
                                that could compromise the wiping process or
                                leave data recoverable.
                            </p>
                        </div>
                        <div className={styles.benefitCard}>
                            <div className={styles.benefitIcon}></div>
                            ...
                            <p className={styles.benefitText}>
                                Direct hardware access and bare-metal
                                programming capabilities essential for bootable
                                environments.
                            </p>
                        </div>
                        <div className={styles.benefitCard}>
                            ...
                            <p className={styles.benefitText}>
                                Fearless concurrency enables parallel wiping of
                                multiple drives and optimized multi-threaded
                                algorithms.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className={styles.featuresGrid}>
                        <div className={styles.featureItem}>
                            ...
                            <p className={styles.featureText}>
                                Target specific partitions, file types, or data
                                patterns while preserving system recovery
                        ...
                        <div className={styles.featureItem}>
                            ...
                            <p className={styles.featureText}>
                                Direct hardware access bypasses software
                                encryption, ensuring complete data destruction
                                even on encrypted drives.
                            </p>
                        </div>
                        <div className={styles.featureItem}>
                            <h4 className={styles.featureTitle}>
                            ...
                            <p className={styles.featureText}>
                                Real-time progress updates and completion
                                reports sent to centralized management systems
                                via network boot.
                            </p>
                        </div>
                        <div className={styles.featureItem}>
                            ...
                            <p className={styles.featureText}>
                                Simultaneously wipe multiple drives connected to
                                the same system with independent progress
                                tracking.
                            </p>
                        </div>
                        <div className={styles.featureItem}>
                            ...
                            <p className={styles.featureText}>
                                Advanced algorithms to handle damaged sectors
                                and ensure complete wiping even on failing
                                drives.
                            </p>
                        </div>
                        <div className={styles.featureItem}>
                            ...
                            <p className={styles.featureText}>
                                Pre-configured wiping profiles for different
                                compliance standards (DoD, NIST, GDPR, etc.).
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className={styles.roadmapTimeline}>
                        <div className={styles.timelineItem}>
                            ...
                            <div className={styles.timelineContent}>
                                ...
                                <p className={styles.timelineText}>
                                    Complete bootloader and basic wiping
                                    algorithms. Support for SATA and NVMe drives
                                    with standard wiping patterns.
                                </p>
                            </div>
                        </div>
                        <div className={styles.timelineItem}>
                            ...
                            <div className={styles.timelineContent}>
                                ...
                                <p className={styles.timelineText}>
                                    Public beta with GUI interface, network
                        ...
                        <div className={styles.timelineItem}>
                            ...
                            <div className={styles.timelineContent}>
                                ...
                                <p className={styles.timelineText}>
                                    Advanced features like selective wiping,
                                    batch processing, and enterprise management
                                    integration.
                                </p>
                            </div>
                        </div>
                        <div className={styles.timelineItem}>
                            ...
                            <div className={styles.timelineContent}>
                                ...
                                <p className={styles.timelineText}>
                                    Production-ready release with full
                                    certification, 24/7 support, and global
                ...
                <div className={styles.ctaSection}>
                    ...
                    <p className={styles.ctaText}>
                        Be among the first to experience the future of secure
                        data destruction. Our beta program offers early access
                        to WIPER OS and direct input into the development
                        process.
                    </p>
